...
const FALLBACK_PROVIDERS: ProviderInfo[] = [
  ...
  { id: "openai", name: "OpenAI", default_url: "https://api.openai.com/v1", default_model: "gpt-4o-mini", requires_api_key: true, api_type: "openai" },
  { id: "anthropic", name: "Anthropic (Claude)", default_url: "https://api.anthropic.com", default_model: "claude-haiku-3-5", requires_api_key: true, api_type: "anthropic" },
...
export function UtilModelSettings() {
  ...
  if (loading) {
    return <div className="p-4">Loading util model settings...</div>;
  }

  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold">Util Model</h3>
        <p className="text-sm text-muted-foreground">
          Model used for utility tasks like classification and routing
        </p>
      </div>

      {/* Add New LLM Form */}
      <div className="border rounded-lg p-4 bg-card space-y-4">
        <h4 className="font-semibold">Add Util Model</h4>
        {error && (
