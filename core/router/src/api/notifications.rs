...
pub fn router() -> Router<AppState> {
    Router::new()
        .route("/api/v1/notifications", get(list_notifications).delete(clear_notifications))
...
async fn get_unread_count(State(state): State<AppState>) -> Result<Json<serde_json::Value>, String> {
